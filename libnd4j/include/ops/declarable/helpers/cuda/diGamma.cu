...
///////////////////////////////////////////////////////////////////
void diGamma(nd4j::LaunchContext * context, const NDArray& n, const NDArray& x, NDArray& z) {

    int threadsPerBlock = MAX_NUM_THREADS;
    int blocksPerGrid = (z.lengthOf() + threadsPerBlock - 1) / threadsPerBlock;

    NDArray::prepareSpecialUse({&z}, {&x});
    BUILD_SINGLE_SELECTOR(n.dataType(), diGammaCudaLauncher, (blocksPerGrid, threadsPerBlock, context->getCudaStream(), x.getSpecialBuffer(), x.getSpecialShapeInfo(), z.getSpecialBuffer(), z.getSpecialShapeInfo()), FLOAT_TYPES);
